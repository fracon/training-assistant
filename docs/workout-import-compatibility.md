...
| COROS | direct | `.FIT` (and `.TCX` for bulk export) | Use COROS Training Hub's activity export and choose FIT |
...
- COROS, “Exporting Workout Data and Uploading to 3rd Party Apps” — https://support.coros.com/hc/en-us/articles/360043975752-Exporting-Workout-Data-and-Uploading-to-3rd-Party-Apps (consulted 2026-09-09; Training Hub/app, activity export).
